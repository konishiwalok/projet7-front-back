...
<template>
  <div class="bg-primary pt-3 pb-5">
    <div class="card col-8 col-lg-4 mx-auto bg-white py-4 borderopa">
      <h3 class="text-secondary mt-3">Connexion</h3>
      <form
        id="form"
        class="mt-5"
      ...
      >
        ...
        >
          ...
          <span class="badge badge-danger" v-if="!$v.email.email"
            >Un email est demandé</span
          >
        </div>
        <div
          class="form-group form-group-sm"
      ...
      <b-alert
        ...
        dismissible
        variant="danger"
        class="col-10 mx-auto mt-5"
        >Identifiant ou mot de passe incorrect ,Veuillez réessayer
      </b-alert>
      <hr class="line w-80" />
      <div class="mt-1 pt-1">
        <button class="btn  bg-info btn-sm" @click.prevent="goSignin">
          Inscription
        </button>
