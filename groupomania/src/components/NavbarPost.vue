    ...
    <div class="container-fluid px-0 sticky">
        <nav class="Navbar ">
            <b-navbar toggleable="lg" type="dark" variant="info">
                <a href="/allpost"><img class="navbar-brand img-fluid logo" src="../assets/icon-left-font-monochrome-white.svg" aria-label="logo groupomania" alt="Logo groupomania"></a>
