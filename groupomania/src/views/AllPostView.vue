        ...
        <div>
          <div class="col d-flex justify-content-between align-items-center p-0 semicua">
            <div>
              ...
              <span class=" font-weight-bold px-3 ml-2">{{ post.User.pseudo }}</span>
            </div>
            <span class="badge text-white align-self-start p-0">{{ post.createdAt.substr(0, 10).split("-").reverse().join("-") }}</span>
          </div>
          <div class="row mx-auto ">
            <div class="col-11 card my-3 py-2 mx-auto semicua_com">
              {{ post.content }}
              <b-img-lazy v-if="post.imageUrl" :src="post.imageUrl" fluid-grow class="semicua mx-auto pt-1" alt="responsive image"></b-img-lazy>
            </div>
